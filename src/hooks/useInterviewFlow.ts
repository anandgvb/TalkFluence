      ...
      try {
        ...
        if (questionCount >= QUESTION_LIMIT) {
          const completionMessage =
            "Simulation completed successfully! Thank you for your participation. You have completed all questions.";
        ...
        console.error("Error in Simulation flow:", errorMessage);
